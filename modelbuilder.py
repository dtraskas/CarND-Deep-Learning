...
class ModelBuilder:
    ...
    def initialise(self):
        ...
        self.model.add(Convolution2D(24, 5, 5, border_mode='valid', activation='elu', input_shape=self.reduced_shape))
        self.model.add(MaxPooling2D(pool_size=(2, 2)))
        self.model.add(Convolution2D(36, 5, 5, border_mode='valid', activation='elu'))
        self.model.add(MaxPooling2D(pool_size=(2, 2)))
        self.model.add(Convolution2D(48, 5, 5, border_mode='valid', activation='elu'))
        self.model.add(MaxPooling2D(pool_size=(2, 2)))
        self.model.add(Convolution2D(64, 3, 3, border_mode='valid', activation='elu'))
        self.model.add(Convolution2D(64, 3, 3, border_mode='valid', activation='elu'))
